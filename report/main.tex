...
% ── Fontes principais ───────────────────────────────────────
%  Corpo: Latin Modern Roman (sucessor OpenType do Computer Modern).
%  Cabeçalhos: TeX Gyre Heros (clone OpenType do Helvetica, \sffamily).
%  Mono: Latin Modern Mono (para listagens de código).
...
%  Nível principal — Helvetica, 18 pt, negrito, centralizado.
%  \clearpage antes de cada \section via hook no format.
\titleformat{\section}
  [block]
  {\clearpage\sffamily\bfseries\fontsize{18pt}{27pt}\selectfont\centering}
  {\thesection}{1em}{}
...
\newcommand{\textbookman}[1]{{\sffamily #1}}
...
\begin{titlepage}
  \begin{center}
    ...
    {\textbookman{\fontsize{24pt}{28pt}\selectfont\bfseries
      Instituto de Fomento e Coordenação Industrial -- IFI/DCTA}}
  \end{center}

  \vspace*{2cm}
  \begin{center}
    \includegraphics[width=6cm]{ifi.jpg}
  \end{center}
  ...
  \begin{center}
    {\large Nome do Aluno: Andryus Marzzona Fernandes Martins}\\[6pt]
    {\large São José dos Campos, SP}
  \end{center}
\end{titlepage}
...
Relatório Final de Estágio Curricular aceito em 15/05/2026 pelos abaixo assinados:}
...
%   {}
% \end{flushright}
\noindent\texttahoma{\fontsize{14pt}{17pt}\selectfont\bfseries INFORMAÇÕES GERAIS}

\vspace{10pt}
{\texttahoma{\fontsize{11pt}{14pt}\selectfont
\noindent\textbf{Estagiário}\\[4pt]
...
\includepdf[pages=-]{frequencia.pdf}
\includepdf[pages=-]{avaliacao.pdf}
